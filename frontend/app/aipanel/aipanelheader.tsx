...
export const AIPanelHeader = memo(() => {
    ...
    return (
        ...
        >
            <h2 className="text-foreground text-sm @xs:text-lg font-semibold flex items-center gap-2 flex-shrink-0 whitespace-nowrap">
            ...
            <div className="flex items-center flex-shrink-0 whitespace-nowrap">
                    ...
                    <div className="flex items-center text-sm whitespace-nowrap">
                        ...
                        <button
                            ...
                            className={`relative inline-flex h-6 w-14 items-center rounded-full transition-colors cursor-pointer ${
                                widgetAccess ? "bg-accent-600" : "bg-keycapborder"
                            }`}
                        ...
                        >
                            ...
                            />
                            <span
                                className={`relative z-10 text-xs text-accentforeground transition-all ${
                ...
                <button
                    ...
                    className="text-secondary hover:text-foreground cursor-pointer transition-colors p-1 rounded flex-shrink-0 ml-2 focus:outline-none"
                    title="More options"
                >
