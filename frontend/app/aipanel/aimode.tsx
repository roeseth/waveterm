    ...
    return (
        <button
            ...
            className={cn(
                ...
                isDisabled ? "text-muted" : "text-foreground hover:bg-hover cursor-pointer"
            )}
        >
    ...
    return (
        <div className="relative" ref={dropdownRef}>
            <button
                ...
                className={cn(
                    "group flex items-center gap-1.5 px-2 py-1 text-xs text-secondary hover:text-foreground rounded transition-colors cursor-pointer border border-border/50",
                    isOpen ? "bg-highlightbg" : "bg-panel hover:bg-hover"
                )}
            ...
            {isOpen && (
                <>
                    ...
                    <div className="absolute top-full left-0 mt-1 bg-modalbg border border-border rounded shadow-lg z-50 min-w-[280px]">
                        ...
                        <button
                            ...
                            className="w-full flex items-center gap-2 px-3 pt-1 pb-1 text-foreground hover:bg-hover cursor-pointer transition-colors text-left"
                        >
                        ...
                        <button
                            ...
                            className="w-full flex items-center gap-2 px-3 pt-1 pb-2 text-foreground hover:bg-hover cursor-pointer transition-colors text-left"
                        >
