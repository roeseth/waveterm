            ...
            <Modal className="restore-backup-modal pb-5 pr-5" onClose={handleClose} onOk={handleClose} okLabel="Close">
                <div className="flex flex-col gap-4 pt-4 pb-4 max-w-xl">
                    ...
                    <div className="text-sm text-secondary leading-relaxed">
                        The file <span className="font-mono text-foreground break-all">{toolData.inputfilename}</span> has
        ...
        return (
            <Modal className="restore-backup-modal pb-5 pr-5" onClose={handleClose} onOk={handleClose} okLabel="Close">
                <div className="flex flex-col gap-4 pt-4 pb-4 max-w-xl">
                    ...
                    <div className="text-sm text-red-400 font-mono bg-panel p-3 rounded break-all">{error}</div>
                </div>
            </Modal>
        );
    }
    ...
    return (
        ...
        >
            <div className="flex flex-col gap-4 pt-4 pb-4 max-w-xl">
                ...
                <div className="text-sm text-secondary leading-relaxed">
                    This will restore <span className="font-mono text-foreground break-all">{toolData.inputfilename}</span>{" "}
